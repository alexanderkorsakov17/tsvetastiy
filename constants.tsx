...
export const PRODUCTS: Product[] = [
  {
    ...
    color: '#E1BEE7',
    composition: 'Цветки лаванды, морская соль, эфирное масло лаванды, овсяные хлопья.',
    contraindications: 'Индивидуальная непереносимость компонентов, беременность (консультация врача), открытые раны на коже.',
    weights: [
      { label: '230 г.', price: 450 },
      { label: '460 г.', price: 800 }
    ]
  },
  {
    id: '2',
